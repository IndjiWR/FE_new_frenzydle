...
// apps/frenzydle/src/app/app.routes.ts
var appRoutes = [
  {
    path: "",
    loadComponent: () => import("./chunk-2N4DWPSZ.js").then((m) => m.HomeComponent)
  },
  {
    path: "user",
    loadComponent: () => import("./chunk-35ATBYIA.js").then((m) => m.UserComponent)
  },
  {
    path: "**",
    redirectTo: ""
...
// libs/shared/data/src/lib/interceptors/mock.interceptor.ts
var mockInterceptor = (request, next) => {
  const simulatedLatency = Math.floor(Math.random() * 500) + 300;
  return next(request);
};

// libs/shared/data/src/lib/shared-data/shared-data.ts
var SharedData = class _SharedData {
  static \u0275fac = function SharedData_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SharedData)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SharedData, selectors: [["lib-shared-data"]], decls: 2, vars: 0, template: function SharedData_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "p");
      \u0275\u0275text(1, "SharedData works!");
      \u0275\u0275domElementEnd();
    }
  }, encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SharedData, [{
    type: Component,
    args: [{ selector: "lib-shared-data", imports: [], template: "<p>SharedData works!</p>\n" }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SharedData, { className: "SharedData", filePath: "libs/shared/data/src/lib/shared-data/shared-data.ts", lineNumber: 9 });
})();

// apps/frenzydle/src/app/app.config.ts
var appConfig = {
  providers: [
    provideBrowserGlobalErrorListeners(),
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ imports: [RouterModule], selector: "app-root", template: "<router-outlet></router-outlet>" }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(App, { className: "App", filePath: "apps/frenzydle/src/app/app.ts", lineNumber: 10 });
})();

// apps/frenzydle/src/main.ts
